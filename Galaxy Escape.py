...
print("$~ Don't get hit by the enemy! Try to eat as many candies as you can to gain more points.")
print("$~ Took me long time to make though. Still was fun to make none-the-less.")
print("$~ This game was made back in 2019, and it is my best Python program I have made before.")
...
player.fill_colour = 'medium spring green'
...
colourRandom = colours[random.randint(0,5)]
...
while True:
    ...
    if running:
        ...
        if game.ispressed('Left') or game.ispressed('d'):
            player.x += playerSpeed

        if game.ispressed('Right') or game.ispressed('a'):
            player.x -= playerSpeed
